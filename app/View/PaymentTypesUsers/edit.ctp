...
<?php echo $this->Form->create('PaymentTypesUser'); ?>
	<fieldset>
		<legend><?php echo __('Edit Payment Types User'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('PaymentTypesUser.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('PaymentTypesUser.id'))); ?></li>
