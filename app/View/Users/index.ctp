<div class="users index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('chinese_name'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($user['User']['chinese_name']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['english_name']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['nick_name']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['phone_number']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['current_country']); ?>&nbsp;</td>
